            ...
            {filteredVendors.map((vendor, index) => (
              ...
              >
                ...
                <td className="py-4 px-4 sm:px-6 text-xs sm:text-sm text-gray-600">
                  ...
                  <button
                    className="px-3 py-1 sm:px-4 sm:py-2 bg-red-600 text-white rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
